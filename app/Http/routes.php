...
//    Route::post('/login/{*}', 'Api@postLogin');
	...
	Route::get('/get-policy/', 'Api@PrivacyPolicy');
    //End Muaawiya's
});
Route::group(array('namespace' => 'Api', 'middleware' => 'apiKey', 'prefix' => 'api_v2'), function() {
    Route::post('/login', 'Api_v2@postLogin');
//    Route::post('/login/{*}', 'Api_v2@postLogin');
    Route::post('/register/', 'Api_v2@RegisterUser');
    Route::get('/categories', 'Api_v2@GetCategories');
    Route::get('/categories/{slug}', 'Api_v2@GetSubCategories');
    Route::get('/supplierlist', 'Api_v2@supplierlist');
    Route::post('/supplierlist', 'Api_v2@supplierlist');
    Route::post('/get-active-suppliers', 'Api_v2@GetactiveSuppliers');
    Route::post('/request-service', 'Api_v2@RequestService');
    Route::post('/uploadimage', 'Api_v2@uploadimage');
    Route::get('/reset-password-request', 'Api_v2@ResetPasswordRequest');
    Route::get('/get', 'Api_v2@getRegisterUser');
    Route::get('/get-buildings-list', 'Api_v2@GetBuildings');
    Route::get('/view-profile', 'Api_v2@ViewProfile');
    Route::post('/update-profile', 'Api_v2@UpdateProfile');
    Route::get('/get-cat-services', 'Api_v2@GetCatServices');
    Route::get('/get-services', 'Api_v2@GetServices');
    Route::get('/get-request-list/{id}', 'Api_v2@getRequestList');
    //Muaawiya's
    Route::get('/get-request-list/{id}', 'Api_v2@getRequestList');
    Route::get('/get-images/', 'Api_v2@getImagesHowItWorks');
	Route::get('/get-states/', 'Api_v2@getStates');
	Route::get('/get-cities/{state_id}', 'Api_v2@getCities');
	Route::get('/get-policy/', 'Api_v2@PrivacyPolicy');
    //End Muaawiya's
});
...
//        Route::post('users/save', 'Users@Save');
	...
	Route::post('verifyformsubmit', 'TwilioVerifyController@sendSMS');
	//Route::controller('verifyformsubmit','TwilioVerifyController@sendSMS');

	Route::get('resendcode', 'TwilioVerifyController@resendcode');
