...
//        exit();
	   ...
	   $data['supplier_approved'] = notificationModel::where('notificationName','supplier_approved')->first();
...
//        print_r($gister);exit();
	   ...
	   $gister=['content'=>$request->get('supplier_approved')];
//        print_r($gister);exit();
       $data['supplier_approved'] = notificationModel::updateOrCreate(['notificationName' => 'supplier_approved'], $gister);
