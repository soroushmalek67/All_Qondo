...
//        exit();
		...
		{	
			if($request->has('new_building') && $request->new_building == 'y')
			{
				...
				//input::merge(["building_id" => $building_id]);
				...
				$request->merge(["building_id" => $building_id, 'city' => $building_info->city_id, 'state' => $building_info->state_id, 'postal_code' => $building_info->postal_code, 'street_address' => $building_info->Address, 'country' => $building_info->country]);
			}
			else
			{
