...
<div class="box box-warning">
    ...
    <form action="{{ url('admin-panel/updateNotifications') }}" enctype="multipart/form-data" class="form-horizontal" method="post">
        ...
        <div class="box-body">
            ...
            <h4> Unregistered/New Supplier Approved Notification(for User)</h4>
            
            <p>
                You can use following variables/short codes to get user information dynamically.(@supplierName, @userEmail, @loginURL)
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea id="textEditor28" class="form-control" placeholder="" type="text" name="supplier_approved">{{$supplier_approved->content}}</textarea>
                </div>
            </div><br/>
