...
@section('page-content')
                    ...
                    @include("partials.form_errors")
                        <form role="form" method="POST" action="{{ url('profile') }}" enctype="multipart/form-data" id="updateProfileForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 registrationFormFieldCont">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="mobile-number" required class="form-control input-lg" name="mobile_number" aria-describedby="basic-addon1" 
                                                    value="{{profileGetFieldsValues(old('mobile_number'), $userDetails->mobile_number)}}" />
                                            <input type="hidden" id="mobile-auth" value="{{ $userDetails->user_type }}" />
                                        </div>
                                    </div>
                                </div>
...
<!--                                            <select  name="building_id" id="building_id" class="customDropdown form-control input-lg" aria-describedby="basic-addon1" data-live-search="true">
                                    ...
                                    <!-- New Building -->
                                    <style type="text/css">
                                    	.building-information-sec input.form-control, .building-information-sec .btn-default {
                                    ...
                                    <div class="building-information-sec">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group login-field">
                                                ...
                                                <input id="building_name" type="text" name="building_name" class="form-control new_building" value="{{old('building_name')}}" placeholder="Building Name">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group login-field">
                                                <span><img src="{{ asset('img/front/form_icon_bus_name.png') }}"></span>
                                                <select name="state_id" id="state_id" class="customDropdown form-control new_building" onchange="getCities(this, 'city_id');" data-live-search="true">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group login-field">
                                                <span><img src="{{ asset('img/front/form_icon_bus_name.png') }}"></span>
                                                <select name="city_id" id="city_id" class="customDropdown form-control new_building" data-live-search="true">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group login-field">
                                                <span><img src="{{ asset('img/front/form_icon_bus_name.png') }}"></span>
                                                <input id="Address" type="text" name="Address" class="form-control new_building" value="{{old('Address')}}" placeholder="Address">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input-group login-field">
                                                <span><img src="{{ asset('img/front/form_icon_bus_name.png') }}"></span>
                                                <input  id="postal_code" type="text" name="postal_code" class="form-control new_building" value="{{old('postal_code')}}" placeholder="Postal code">
                                            </div>
                                        </div>
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Please Enter Code Your Received</h4>
                                    </div>
