...
<!--            <div class="silder-heading">
            ...
            <div class="app-img-div">
                <a target="_blank" href="{{url('https://itunes.apple.com/us/app/qondo/id1224486920')}}">
                    <img src="{{asset('img/front/newhome/download-app.png')}}">
                </a>

                <a target="_blank" href="{{url('https://play.google.com/store/apps/details?id=com.qondo.qondo&hl=en')}}">
                    <img src="{{asset('img/front/newhome/download-app2.png')}}" style="padding-left: 30px;">
                </a>
