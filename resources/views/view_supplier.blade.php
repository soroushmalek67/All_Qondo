                            ...
                            <div class="row">
                                <form action="{{url('suppliers-list')}}" method="get">
                                    <div class="col-sm-12 search">
                                        <input type="search" class="form-control" name="searchKeywork" placeholder="What service do you need?" 
                                ...
                                <div class="contact-detail">
                                    <li>
                                      ...
                                      <p><b>Website : </b><a href="{{url($supplierDetails->website)}}" target="_blank">{{$supplierDetails->website}}</a></p>
                                        ...
                                        @else
                                          <p><b>Website : </b>
                                          	@if($supplierDetails->website != '' && strpos($supplierDetails->website, '.') !== false)<a href="<?php echo "http://"?>{{($supplierDetails->website)}}" target="_blank">{{$supplierDetails->website}}</a></p>@endif
                                        @endif
                                    </li>
                                </div>
                                @if ($supplierDetails->status != 6)
