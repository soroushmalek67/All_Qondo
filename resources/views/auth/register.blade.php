    ...
    <div class="loginFormCont registrationFormCont signupShortForm">
        <form role="form" id="registerationForm" method="POST" action="{{ url('/auth/register') }}">
            ...
            <div class="row">
                ...
                <?php /*?><div class="col-sm-12 loginFormSectionNwForm">
                ...
                <div class="col-sm-12">
                    <div class="userTypeCont">
                        <label style="color:#F60">I am a... *</label>
                        ...
                        <span class="radioBtnCont">
                            <input type="radio" name="iAmA" value="2" id="iAmAVal2" @if (old('iAmA') == 2) checked  @endif onclick="signupShowHideBuyerSupplierFields(this)" required />
                            <label for="iAmAVal2">Contractor</label>
                        </span>
						<?php /* This check should be added to manager - @if (old('iAmA') == 1) checked  @endif */ ?>
                        <span class="radioBtnCont">
                            <input type="radio" name="iAmA" value="1" id="iAmAVal3" onclick="signupShowHideBuyerSupplierFields(this)" required />
                ...
                <div class="col-sm-12 loginFormSectionNwForm">
                    <div class="loginFormSectionNwFormInner  along_with_social">
                        <div class="row">
                            ...
                            <div class="col-sm-12 buisness-name">
                                <div class="input-group login-field">
                                    <span>
                                        ...
                                        <a data-toggle="tooltip" data-html="true" id="info_tooltip_building" title="The business name is the visible name used<br/>to communicate with other users">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group login-field">
                                    <span><img src="{{ asset('img/front/form_icon_phone.png') }}"><!--<a data-toggle="tooltip" data-html="true" id="info_tooltip_building" title="Enter mobile number with country code : +1234567890"><i class="glyphicon glyphicon-info-sign"></i></a>--></span>
                                    <div style="position:absolute;color:#6F6F6F;padding:a;padding-top:13px;font-size:16px;font-family:MuseoSans100;z-index:999;background-color: #f0f2f3;padding-bottom: 10px;border-right: 1px solid #d4d4d4;padding-right: 7px;padding-left: 3px;">+1</div>
                                    <input type="text"  required name="mobile_number" id="personnum" class="form-control" placeholder="Cell Phone Number" value="" style="padding-left:40px">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="input-group login-field">
                            ...
                            <div class="col-sm-12 registrationFormFieldCont sectionThreeTermsAndConditions">
                                <span class="checkboxCont margin-top-15">
                                    <label for="termsAndConditions"><p style="font-size: 13px;color: gray;">By clicking "Join QONDO", I acknowledge and agree to the 
										<a data-toggle="modal" role="button" href="#myModal"><u style="font-size: 13px;">Terms of Use and Privacy Policy</u></a>.</p>
                                    </label>
                                </span>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="text-center submit-btn-auth">
                                        <input type="submit" class="" value="Join QONDO" id="join-qondo">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-sm-12 otherLogins register text-center">
            <div class="col-sm-12 social_login_div">
                <h3><strong>Signup</strong> Easier with Soical Media</h3>
                <label style="color:#F60">I am a... *</label>
                <span class="radioBtnCont">
            ...
            <a class="fb-login" href="#" onclick="fblogin();return false;">&nbsp;</a>
            <a class="in-login" href="#" onclick="liAuth();return false;">&nbsp;</a>
        </div>
        <!--social login--> 
    </div>
...
<form role="form" id="social_form" method="POST" action="{{ url('/sociallogin') }}">
    ...
    <input type="hidden" id="social_flag1" value=1 name="social_flag">
    <input type="hidden" id="userType" value="" name="userType">
</form>
<script type="text/javascript">

    /*$("#join-qondo").click(function(){
		alert($('#registerationForm').serialize());
	});*/
...
//        }
	...
	$("#personnum_").keydown(function(e) {
	var oldvalue=$(this).val();
	var field=this;
	var code = '';
	setTimeout(function () {
		if(oldvalue.slice(0,2) !== '+1') {
			$(field).val('+1' + oldvalue.replace('+', ''));
		}
		//$(field).val('+1' + oldvalue.replace('+', '')); 
	}, 1);
	});
