...
function setup_framework_options() {
    ...
    $sections[] = array(
		...
		array(
                ...
                'options' => array('sacramento' => 'Sacramento', 'malibu' => 'Malibu', 'berkeley' => 'Berkeley', 'riverside' => 'Riverside', 'irvine' => 'Irvine'),
				'std' => 'sacramento'
			),
		...
		array(
            ...
            'type'      => 'button_set',
            'title'     => __('CSS Minifyer', WEBNUS_TEXT_DOMAIN),
            'options'   => array('1' => 'Enable', '0' => 'Disable'),
			),
    ...
    $sections[] = array(
        ...
        'fields' => array(
			...
			array(
                'id' => 'webnus_slogan',
                'type' => 'text',
                'title' => __('Slogan text', WEBNUS_TEXT_DOMAIN),
            ),
            ...
            array(
                ...
                'options' => array(
					...
					'10' => array('title' => __('Header Type 10', WEBNUS_TEXT_DOMAIN), 'img' => $theme_img_dir . 'menutype/menu10.png')
				),
				'std' => '1'
			),
			array(
 			...
 			array(
		  	...
		  	array(
                ...
                'type' => 'select',
                'title' => __('Header Right side', WEBNUS_TEXT_DOMAIN),
                'desc' => __('For Header Type 2,3,4,5,9',WEBNUS_TEXT_DOMAIN),
	...
	$sections[] = array(
        ...
        'fields' => array(		 
			...
			array(
                ...
                'type' => 'text',
                'title' => __('Topbar Phone Number', WEBNUS_TEXT_DOMAIN),
                'std' => '+1 234 56789'
            ),
            array(
                'id' => 'webnus_topbar_email',
                'type' => 'text',
                'title' => __('Topbar Email Address', WEBNUS_TEXT_DOMAIN),
                'std' => 'info@yourdomain.com'
            ),
...
*/
    ...
    $sections[] = array(
		...
		'desc' => '<p class="description">Any custom CSS from the user should go in this field, it will override the theme CSS.</p>',
        'fields' => array(

            array(
                'id' => 'webnus_custom_css',
                'type' => 'textarea',
                'title' => __('Your CSS Code', WEBNUS_TEXT_DOMAIN),
            ),
        )
    );
