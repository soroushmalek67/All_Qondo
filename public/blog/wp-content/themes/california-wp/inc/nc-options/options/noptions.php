						...
						echo '<div id="import_export_default_section_group'.'" class="nhp-opts-group-tab">';
							...
							echo '<div id="nhp-opts-import-link-wrapper">';
								...
								echo '<select id="import-link-value" name="'.$this->args['opt_name'].'[import_link]">
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/sacramento.txt">Sacramento</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/malibu.txt">Malibu</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/berkeley.txt">Berkeley</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/riverside.txt">Riverside</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/irvine.txt">Irvine</option>
										</select>';
