...
! function(e) {
    ...
    t.utils = n, e.Autocomplete = t, t.formatResult = function(e, t) {
        ...
        console.log(e.optionType);
        
        if(e.optionType=="city"){
            
            
            return "<span style='font-weight: bold;  padding-left: 25px;' >City</span><br><span><img src = '"+URL+"/img/front/city.png' style='margin-right: 10px; width : 25px'></span>"+e.value;
            
        }
        if(e.optionType=="company"){
            
            
            return "<span style='font-weight: bold;  padding-left: 25px;' >Company</span><br><span><img src = '"+URL+"/img/front/company1.png' style='margin-right: 10px;  width : 25px'></span>"+e.value;
            
        }
        if(e.type=="category"){
            
            
            return "<span style='font-weight: bold;  padding-left: 25px;' >Category</span><br><span><img src = '"+URL+"/img/front/category.png' style='margin-right: 10px;  width : 25px'></span>"+e.value;
            
        }
        if(e.type=="service"){
            
            
            return "<span style='font-weight: bold;  padding-left: 25px;' >Service</span><br><span><img src = '"+URL+"/img/front/service1.png' style='margin-right: 10px;  width : 25px'></span>"+e.value;
            
        }
        return e.value.replace(new RegExp(o, "gi"), "<strong>$1</strong>").replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/&lt;(\/?strong)&gt;/g, "<$1>").replace(/&lt;(\/?span)&gt;/g, "<$1>")
