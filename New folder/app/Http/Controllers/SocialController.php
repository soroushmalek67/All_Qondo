...
//                    ->orwhere('email',$request->get('email'))
            ...
            if ($user->user_type == 3 || $request->get('userType') == $user->user_type) {
                ...
                return back()->withErrors("<strong>Wrong Type Selected:</strong> Your company type is Supplier.");
            } else if ($user->user_type == 1) {
                return back()->withErrors("<strong>Wrong Type Selected:</strong> Your company type is Buyer.");
            }
        }
//           $user->updateStatus();
        return;
