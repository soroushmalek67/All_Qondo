    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 terms_conditions">
                ...
                <p>If you're a service provider and you're looking for more efficient and effective marketing opportunities, check out our <a href="{{url('analytics')}}">business analytics</a>.</p>
