                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 registrationFormFieldCont">
                                        ...
                                        <div class="input-group building-dropdown">
                                            ...
                                            <input type="text" id="get_building_name" required name="building_name" class="form-control input-lg" value="{{ profileGetFieldsValues(old('building_name'), $userDetails->Address.', '.$userDetails->building_name)}}" 
