                            ...
                            <div class="col-md-12">
                                <div class="banner-text homeTopBannerText">
                                    ...
                                    <span class="text-center">
                                        <input type="submit" class="submit" onclick="window.location.href='{{url('request-service')}}'" 
...
<!--                            <iframe src="https://player.vimeo.com/video/142444258" width="568" height="281" frameborder="0" webkitallowfullscreen 
                                    mozallowfullscreen allowfullscreen></iframe>-->
<!--                            <video width="568" controls>
                                <source src="{{ asset('videos/FIRMOGRAM-07-Aug.mp4') }}" type="video/mp4">
                                <source src="{{ asset('videos/FIRMOGRAM-07-Aug.mp4') }}" type="video/ogg">
                        ...
                        <div class="homeWhyFirmogramSubSection homeSmallContiner">
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    <h2>EASY TO USE!</h2>
                                    <!--<p> We simplify day-to-day service procurement from local professionals. QONDO makes it simple and fast for you to upload your service or product request. Just fill in the request form and provide details and the rest is up to us!</p>-->
                                    <p>QONDO streamlines your needs by presenting you with qualified service providers in your area. Just fill in the request form and you can leave the rest to us!</p>
                                </div>
                                <div class="col-sm-4 text-right">
                                    <img src="{{ asset('img/front/first-div.gif') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="homeWhyFirmogramSubSection homeSmallContiner">
                    <div class="row">
                        ...
                        <div class="col-sm-5 text-right">
                            <img src="{{ asset('img/front/Firmogram_r7_c6.gif') }}" alt=""/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="works">
            <div class="container">
                <div class="homeFindRightSupplierSection homeSmallContiner">
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="{{ asset('img/front/contact.gif') }}" alt="">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <p>Using the QONDO marketplace, you’ll have access to detailed information on your complete supplier ecosystem and sales 
                                opportunities, in real-time. Have confidence knowing that QONDO will be keeping a close eye on business activities 
